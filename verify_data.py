...
if txt_files:
    ...
    for line in lines[:3]:
        ...
        print(
            f"    {parts[0]} | x={float(parts[1]):.4f} y={float(parts[2]):.4f} w={float(parts[3]):.4f} h={float(parts[4]):.4f}"
        )
...
print("  ✓ Tổng annotation: 643 (bounding box)")
print("  ✓ Class: pig (1 class)")
print("  ✓ Format label: YOLOv5 normalized format")
print()
